...
CREATE TABLE products (id int primary key auto_increment, name varchar(50) not null unique, price float not null default 0, cost float not null default 0,
...
create table costumers(id int primary key auto_increment, name varchar(50) not null unique, account_number int not null unique, logo text, logo_public_id text, deleted_at datetime);
...
create table balances(id int auto_increment primary	key, costumer_id int not null unique, balance_amount float not null,
